...
codeBot = await conn.sendMessage(
  m.chat,
  {
    text: `*ര ׄ 🔐 ׅ  Vincula tu cuenta usando este código:*\n\n*➪ \`CODIGO\` ›* \`\`\`${secret}\`\`\`\n\n🌱 \`Sigue las instrucciones:\`\n*1 » Click en los tres puntos en la esquina superior derecha*\n*2 » Dispositivos vinculados*\n*3 » Vincular nuevo dispositivo*\n*4 » Vincular usando número*\n\n> *Nota:* Este código solo funciona en el número que lo solicito.`,
    title: "⌂ ݁   🌾՞     _`𝐉𝐀𝐃𝐈𝐁𝐎𝐓`_      ݁  𐴲੭",
    footer: dev,
    interactiveButtons: [
      {
        name: "cta_copy",
