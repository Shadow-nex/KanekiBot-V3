...
txtCode = await conn.sendMessage(
  m.chat,
  {
    image: { url: 'https://raw.githubusercontent.com/AkiraDevX/uploads/main/uploads/1766671138254_772283.jpeg' },
    caption: rtx2
  },
  { quoted: m }
)
codeBot = await conn.sendMessage(
  m.chat,
  {
    text: secret,
    title: "",
...
m?.chat ? await conn.sendMessage(m.chat, { text: isSubBotConnected(m.sender) ? `
 🌿 @${m.sender.split('@')[0]}, ya estás conectado, leyendo mensajes entrantes...` : `❀ Has registrado un nuevo *Sub-Bot!* [@${m.sender.split('@')[0]}]\n\n> Puedes ver la información del bot usando el comando *#infobot*`, mentions: [m.sender] }, { quoted: m }) : ''
}}
setInterval(async () => {
if (!sock.user) {
