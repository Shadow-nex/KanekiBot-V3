...
await conn.sendMessage(m.chat, { document: { url: data5.dllink }, mimetype: 'application/vnd.android.package-archive', fileName: data5.name + '.apk', caption: null, ...fake }, { quoted: m })
await m.react('✔️')
} catch (error) {
await m.react('✖️')
